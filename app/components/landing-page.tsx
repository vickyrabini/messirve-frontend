...
export default function LandingPage({ isAuthenticated }: Props) {
  ...
  return (
    <div className="font-sans text-ink antialiased overflow-x-hidden">
      ...
      <section
        id="top"
        className="relative overflow-hidden bg-celeste pt-36 pb-24 sm:pt-40 sm:pb-28"
      >
        <div
          data-parallax="0.15"
          className="pointer-events-none absolute -right-[260px] -top-[160px] h-[760px] w-[760px] bg-cream opacity-[0.16]"
          style={{
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 grid lg:grid-cols-[1.15fr_0.85fr] gap-14 items-center">
          <div data-stagger>
            ...
            <h1 className="reveal mt-6 font-brand uppercase text-[clamp(2.8rem,6.5vw,5rem)] leading-[1.02] text-white text-balance">
              Las páginas <span className="text-dorado">amarillas</span> de los
              nuestros
            </h1>

            <p className="reveal mt-6 max-w-xl text-lg leading-relaxed text-white/95">
              Encontrá servicios de tu comunidad, valorados por quienes
              entienden exactamente de dónde venís y qué buscás.
            </p>
          ...
          <div className="relative">
            <div
              className="reveal rounded-3xl bg-cream p-8"
              style={{ boxShadow: "0 30px 70px -20px rgba(27,42,61,0.35)" }}
            >
              ...
              <div className="mt-5 flex items-center gap-2">
                <span className="text-dorado text-lg tracking-[2px]">
                  ★★★★★
                </span>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="mt-14 grid sm:grid-cols-3 gap-6" data-stagger>
            <div className="reveal rounded-3xl border border-gris/40 bg-white p-9">
              <div className="grid h-16 w-16 place-items-center rounded-2xl bg-celeste font-brand text-3xl text-white">
                1
              </div>
              <h3 className="mt-6 font-brand uppercase text-2xl text-ink">
                Buscá
              </h3>
            ...
            <div className="reveal rounded-3xl border border-gris/40 bg-white p-9">
              <div className="grid h-16 w-16 place-items-center rounded-2xl bg-dorado font-brand text-3xl text-celeste-deep">
                2
              </div>
              <h3 className="mt-6 font-brand uppercase text-2xl text-ink">
                Compará
            ...
            <div className="reveal rounded-3xl border border-gris/40 bg-white p-9">
              <div className="grid h-16 w-16 place-items-center rounded-2xl bg-celeste-deep font-brand text-3xl text-white">
                3
              </div>
              <h3 className="mt-6 font-brand uppercase text-2xl text-ink">
                Contactá
      ...
      <section
        id="emprendedores"
        className="relative bg-celeste-deep overflow-hidden"
      >
        <div
          data-parallax="0.15"
          className="pointer-events-none absolute -left-[240px] -bottom-[260px] h-[680px] w-[680px] bg-dorado opacity-[0.12]"
          style={{
            maskImage: "url(/sun-decor.svg)",
            WebkitMaskImage: "url(/sun-decor.svg)",
            maskSize: "contain",
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 py-20 sm:py-24 flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl" data-stagger>
            ...
            <p className="reveal mt-5 text-lg leading-relaxed text-white/85">
              Sumá tu servicio para no quedarte afuera de la comunidad
              rioplatense en la ciudad. Tus compatriotas te necesitan.
            </p>
          </div>
          <Link
            href="/register"
      ...
      <footer className="bg-celeste-deep">
        <div className="text-center py-9 px-5">
          <span className="font-brand uppercase text-3xl tracking-[0.06em] text-dorado">
            Messirve te sirve
          </span>
        </div>
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-5 pb-14 sm:flex-row sm:justify-between sm:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            <a
              href="#"
              className="text-[16px] text-white/75 transition-colors hover:text-white"
            >
              Sobre nosotros
            </a>
            <a
